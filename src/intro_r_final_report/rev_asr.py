...
from rev_ai import Job, Transcript, apiclient
...
class RevAsr:
    ...
    def check_audio(self, audio_path: Path):
        ...
        if audio.duration_seconds <= 2:
            ...
            warn("Since audio duration less than 2 sec, padded silence.")
    ...
    def recognize_speech(self, audio_path: Path, wait=60, timeout=600, df=True):
        ...
        - df: bool ... if df=True, return a transcription as a pandas.DataFrame object. if df=False, return a rev_ai.
        """
